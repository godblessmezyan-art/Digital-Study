...
export const THEMES = {
  'cloud-realm': {
    ...
    scenes: [
      ...
      {
        id: 'cloud-archive-tower',
        code: 'CR-03',
        name: '云端藏书塔',
        region: '北侧藏书院 · 高层阅览室',
        description: '越过落灰的典籍与无人踏足的回廊，眺望云海尽头的断翼峰。',
        image: 'assets/scenes/cloud-archive-tower-grounded-v4.png',
        focus: { desktop: '56% 50%', tablet: '59% 50%', mobile: '67% 48%' },
      },
      {
        id: 'forbidden-specimen-conservatory',
        code: 'CR-04',
        name: '禁忌标本温室',
        region: '下层研究院 · 封闭培育区',
        description: '雨水滑过修补的旧玻璃，雾气背后有一件无法确认是否仍然存活的标本。',
        image: 'assets/scenes/forbidden-specimen-conservatory-grounded-v1.png',
        focus: { desktop: '54% 50%', tablet: '57% 50%', mobile: '62% 49%' },
      },
    ],
    colors: {
      primary: '#173653',
